...
<div class="row">
    ...
    <div class="col-md-9">
        <form method="post" action="/fields/{{ $field->id }}/submit-pest">
            @csrf
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <div class="mb-3">
                        ...
                        <!-- field for comments on pest reports-->
                        <div class="mb-3">
                            <label for="pest_comments" class="form-label">Comments</label>
                            <input type="text" class="form-control" id="pest_comments" name="pest_comments">
                        </div>
