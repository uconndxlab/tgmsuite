...
<div class="row">
    ...
    <div class="col-md-9">
        <form method="post" action="/fields/{{ $field->id }}/submit-soil">
            @csrf
            <div class="row">
                <div class="col-12">
                    <h3>Submit Soil Test Report</h3>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="mb-3">
                        <label for="soil_comments" class="form-label">Comments</label>
                        <textarea class="form-control" id="soil_comments" name="soil_comments" rows="3"></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
