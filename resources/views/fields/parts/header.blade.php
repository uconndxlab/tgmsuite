...
<head>
    ...
    <title>Athletic Field Assessment Tool</title>
    ...
    <link href="{{ asset('static/css/grid.css') }}" rel="stylesheet">
    <link href="{{ asset('static/css/banner.css') }}" rel="stylesheet">
...
<header>
  <div class="container row" style="padding:30px 0px;margin:auto;">
    <div class="col-lg-8">
      ...
      <a href="/" class="link-offset-1">Athletic Field Assessment Tool
      </a>
      </h1>
    </div>
  <!-- Navbar -->
  
    <nav class="navbar col-lg-4 navbar-expand-lg navbar-light">
      <div class="">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            @auth
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a hx-boost="true" class="nav-link active" style="margin-right:10px" href="/fields">Fields</a>
                </li>
                @if (Auth::user()->is_admin)
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="adminDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="margin-right:10px">
                    <i class="bi bi-shield-check"></i> Admin
                  </a>
                  <ul class="dropdown-menu" aria-labelledby="adminDropdown">
                    <li><a class="dropdown-item" href="/admin/submissions"><i class="bi bi-file-earmark-text"></i> Submissions</a></li>
                    <li><a class="dropdown-item" href="/admin/users"><i class="bi bi-people"></i> User Management</a></li>
                  </ul>
                </li>
                @endif
                <li class="nav-item">
                  <a hx-boost="true" class="nav-link" style="margin-right:10px" href="/profile">
                    <i class="bi bi-person-circle"></i> Profile
                  </a>
                </li>
              </ul>
              <form class="d-flex text-light" action="/logout" method="post">
                @csrf
                <button type="submit" class="btn btn-success">Log Out</button>
              </form>
            @endauth
            @guest
              <a class="btn btn-success" href="/home">Log In</a>
            @endguest
        </div>
      </div>
    </nav>
...
<main id="app" style="padding:40px 0px;">
