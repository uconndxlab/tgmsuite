            ...
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <a href="/fields/{{ $field->id }}" class="
                        @if(!isset($edit) || !$edit) active @endif
                    ...
                    <a href="/fields/{{ $field->id }}/edit" class="
                        btn btn-sm btn-outline-secondary @if(isset($edit) && $edit) active @endif">
                        <i class="bi-pencil"></i>
                        Edit</a>
    ...
    <div class="col-md-9">
        <h3>Viewing a Report</h3>
            ...
            @elseif ($report->type == 'evaluation')
                Turf Quality Rating
            @else
                {{ ucfirst(str_replace("_", " ", $report->type)) }} Type Report
            @endif
    </br>
        Report #{{ $report->id }}
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        @if (isset($content->color_comments))
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="10">
                        ...
                        @if (isset($content->quality_comments))
        ...
        <table class="table table-striped show-full-table show-full-table-mobile">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="5">
                        <strong>Additional Comments:</strong> <br/>
                        @if (isset($content->topdressing_comments))
        ...
        <table class="table table-striped show-full-table-mobile show-full-table">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="7">
                        <strong>Additional Comments:</strong> <br/>
                        @if (isset($content->fert_comments))
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            @php
                                ...
                                $species_list = explode(',', $content->species);
                            @endphp
                    ...
                    <tr>
                        <td colspan="7">
                            <strong>Additional Comments:<br/></strong>
                            @if (isset($content->overseed_comments))
