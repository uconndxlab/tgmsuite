    ...
    <div class="col-md-3">
        <div class="field-lede">
            ...
            <div class="btn-group" role="group">
                <a class="btn btn-secondary" href="/fields/{{ $field->id }}/edit">Edit</a>
                <a class="btn btn-secondary" href="/fields/{{ $field->id }}">History</a>
            </div>
        </div>
    </div>

    <div class="col-md-9">
        <form method="post" action="/fields/{{ $field->id }}/quality-checklist">
            @csrf
            <div class="row">
                <div class="col-12">
